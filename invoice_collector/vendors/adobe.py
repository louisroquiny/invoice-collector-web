...
VENDOR = "adobe"
DEFAULT_URL = "https://adminconsole.adobe.com/support"
...
def collect_invoice(
    ...
    with PersistentBrowser(VENDOR, profiles_root, headless=headless) as (_, _, page):
        ...
        return save_first_matching_download(
            ...
            fallback_message=f"Aucune facture Adobe trouvée automatiquement pour {period}. Le chemin exact dépend de votre Admin Console.",
        )
