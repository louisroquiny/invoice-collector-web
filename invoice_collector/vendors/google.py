...
VENDOR = "google"
DEFAULT_URL = "https://console.cloud.google.com/billing"
...
def collect_invoice(
    ...
    with PersistentBrowser(VENDOR, profiles_root, headless=headless) as (_, _, page):
        ...
        return save_first_matching_download(
            ...
            fallback_message=f"Aucune facture Google trouvée automatiquement pour {period}. Vérifiez si votre facture est dans Google Cloud Billing ou Google Workspace Admin.",
        )
